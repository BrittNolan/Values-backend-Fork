...
export const analyzeSchema = z.object({
  ...
  // practiceMode changes the session-log extraction shape (Practice returns
  // whatsWorking/whatToWatch/suggestedRewrite, not valuesAnalysis/recommendedAction).
  practiceMode: z.boolean().optional(),
  // skipSessionLog suppresses the session insert entirely. Used by silent
  // HR-check and TM-perspective classifiers that route the user, not coach them.
  skipSessionLog: z.boolean().optional()
})
