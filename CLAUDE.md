...
This is the **Values-Align** project at `C:\Users\britt\Desktop\AOS\Values-Align` - its own isolated workspace.
...
## Project notes
<!-- Stack, conventions, gotchas, env vars, deploy targets - fill in over time. -->
